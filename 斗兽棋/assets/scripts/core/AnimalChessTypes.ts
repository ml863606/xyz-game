...
export type Terrain = 'land';

export type GameStatus = 'waiting' | 'playing' | 'finished';

export type WinReason = 'capture' | 'no-moves' | 'resign' | 'timeout' | 'disconnect';
...
export interface GameState {
  ...
  sideOwners: Partial<Record<PlayerSide, string>>;
  winner?: PlayerSide;
  reason?: WinReason;
  message: string;
  lastMove?: MoveRecord;
