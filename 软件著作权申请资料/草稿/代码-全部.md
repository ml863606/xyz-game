...
// File: scripts/lightning_bolt.gd
...
// File: scripts/platform_adapter.gd
...
func share() -> void:
    ...
    pass
// File: scripts/rocket_projectile.gd
...
```text
[gd_scene load_steps=2 format=3 uid="uid://dartballoonmain"]
[ext_resource type="Script" path="res://scripts/game.gd" id="1_game"]
[node name="Main" type="Node2D"]
script = ExtResource("1_game")
// File: test/auto_main.tscn
[gd_scene load_steps=2 format=3 uid="uid://dartballoonautomated"]
[ext_resource type="Script" path="res://scripts/game.gd" id="1_game"]
[node name="AutoMain" type="Node2D"]
script = ExtResource("1_game")
start_auto_demo = true
start_capture_frames = true
```
